...
inputFile = LOAD 'hdfs:///user/mahesh/inputs' USING PigStorage('\t') AS (name:chararray, line:chararray);
...
rmf hdfs:///user/mahesh/PigProjectOutput;

-- storing the result
STORE result INTO 'hdfs:///user/mahesh/PigProjectOutput';